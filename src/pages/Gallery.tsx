...
import { Award, Star, Camera, Heart, Phone } from "lucide-react";
    ...
    <div className="min-h-screen bg-background text-foreground">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/gallery" className="text-red-600 font-medium">
                Gallery
              </Link>
      ...
      <section className="bg-gray-50 py-20 px-4 text-center">
        <div className="max-w-7xl mx-auto">
          <Camera className="w-16 h-16 mx-auto mb-6 text-red-600" />
      ...
      <section className="py-20 px-4 bg-red-600">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-white">Create Your Own Memories</h2>
